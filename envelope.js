...
const settings={left:15,bottom:14,seat:5,name:2};
...
function fitName(el){
  ...
  if(!line)return;
  while(size>0.9 && line.scrollWidth>line.clientWidth){
    size-=.05;
    el.style.fontSize=size+'cm';
  }
}
...
$('resetSettingsBtn').onclick=()=>{
  Object.assign(settings,{left:15,bottom:14,seat:5,name:2});
  $('leftOffset').value=15;$('bottomOffset').value=14;$('seatSize').value=5;$('nameSize').value=2;
  render();
};
